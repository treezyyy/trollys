...
public class EquipmentController {
    ...
    public ResponseEntity<List<EquipmentDTO>> getEquipmentByVin(@PathVariable String vin) {
        List<EquipmentDTO> equipmentList = equipmentService.findByTransportVin(vin);
